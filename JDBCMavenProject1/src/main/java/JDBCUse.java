...
class JDBCUse 
{
 public static void main(String[] args) throws Exception 
 {
     ...
     String q1 = "insert into student values(7,'Deva',26)"; // Query to be run
     String q2 = "insert into student values(8,'MOti',26)";
     String q3 = "insert into student values(9,'Tuki',27)";
     String q4 = "insert into student values(10,'Reva',28)";
